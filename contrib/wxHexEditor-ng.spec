...
License:		GPL
Group:			Editors
URL:			https://github.com/dariox86/wxHexEditor-ng
...
%description
wxHexEditor-ng is another GUI hex editor for open HUGE files and devices
in linux mainland. Designed for reverse engineering binary files.
With wxHexEditor-ng, you can edit huge files and devices like (hdd/sdd).

This programs supports tagging parts of the file for taking notes and make it easier reverse engineer huge binary files.

wxHexEditor-ng program code supports lots of operating system, because
